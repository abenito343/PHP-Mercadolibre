...
<body>
<form id="form1" name="form1" method="post" action="registrarseok.php" enctype="multipart/form-data">
<p>Registrarse:</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="652" height="469" border="0" cellspacing="0">
    ...
    <tr>
      <th align="left" scope="row">Usuario:
        <label for="usuario1"></label>
        <input type="text" name="usuario1" id="usuario1" /></th>
    </tr>
    <tr>
      <th height="48" align="left" scope="row"><p>Contraseña:
    ...
    <tr>
      <th height="88" align="left" scope="row">Año de nacimiento :
        <label for="ano1"></label>
...
<p>
  <input type="submit" name="registrarse1" id="registrarse1" value="registrarse" />
</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
